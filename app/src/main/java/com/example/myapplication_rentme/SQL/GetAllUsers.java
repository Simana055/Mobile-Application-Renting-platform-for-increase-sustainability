package com.example.myapplication_rentme.SQL;

import androidx.appcompat.app.AppCompatActivity;
import androidx.recyclerview.widget.RecyclerView;

import com.example.myapplication_rentme.model.UserListData;
...
public class GetAllUsers {
    ...
    public  ArrayList<UserListData> GetListOfUsers(){
        ...
        userList.add(new UserListData("Mike","mike@gmail.com","User"));
        userList.add(new UserListData("Brady","brady@gmail.com","User"));
        userList.add(new UserListData("Roger","Roger@gmail.com","User"));
        return userList;
    }
